...
export function Hero() {
  return (
    <section className="relative min-h-[560px] lg:min-h-[600px] lg:h-[72svh] lg:max-h-[740px] flex items-center overflow-hidden bg-slate-950">
      <img
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12 md:pb-16">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <div className="animate-[hero-rise_1.05s_ease-out_both]">
