        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <ol className="list-decimal pl-5 space-y-1 text-violet-900/90">
              ...
              <li>콜업체 통화내역을 <b>복사 붙여넣기</b> 또는 엑셀/CSV <b>업로드</b> (헤더 없어도 표준 열 순서로 자동인식)</li>
      ...
      {tab === 'logs' && (
        <div className="space-y-5">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
            ...
            <p className="text-xs text-slate-500 mb-3">
              콜업체 시트에서 복사해 붙여넣거나 파일(xlsx/xls/csv)을 업로드합니다.
              헤더가 없어도 <b>발신번호 가상번호 착신번호 통화일자 …</b> 표준 순서면 자동 인식합니다.
