...
const fallbackCategories = ['전체', '디지털상품', '도메인', '쇼핑몰', '뷰티', '건강', '생활', '기타'];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-10">
          ...
          <p className="text-slate-600 text-lg max-w-3xl">
            결제·구매·이용 확정 실적 기준으로 수수료를 받을 수 있는 CPS 캠페인입니다. ONOFF 플랫폼 상품은 Core 수수료 규칙을 따릅니다.
          </p>
        </div>
...
function CpsCard({ item }: { item: PublicCampaign }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-xl hover:border-cyan-300 transition-all flex flex-col">
      {item.thumbnailUrl ? (
        <div className="aspect-[16/10] bg-slate-100 overflow-hidden border-b border-slate-100">
          <img
      ...
      <div className="p-4 bg-slate-50 border-t border-slate-100 flex gap-3">
        <a
          href={item.landingUrl || 'https://domain.icrm.co.kr/'}
          target="_blank"
